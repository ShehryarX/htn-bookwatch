...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  boolean handleOcrDecode(final OcrResult ocrResult) {
    ...
    final String bookName = ocrResult.getText();

    CountDownTimer countDownTimer = new CountDownTimer(3000, 1000) {
      public void onTick(long millisUntilFinished) {
      }
      public void onFinish() {
        Intent goToNextActivityIntent = new Intent(context, SelectBookActivity.class);
        goToNextActivityIntent.putExtra("bookName", ocrResult.getText());
  ...
  void handleOcrContinuousDecode(OcrResult ocrResult) {
    ...
    lastResult = ocrResult;
    String bookName = ocrResult.getText();
